...
def sigin_required(fn):
    def wrapper(requerst,*args,**kwargs):
        if not requerst.user.is_authenticated:
            return redirect("login")
        else:
            return fn(requerst,*args,**kwargs)
    return wrapper    
